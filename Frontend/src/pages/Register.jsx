      ...
      >
        ...
        <div className="flex items-start gap-2">
          ...
          <label className="text-gray-600 text-sm cursor-pointer">
            I agree to the{" "}
            <span className="text-blue-500 hover:underline md:text-lg sm:text-base text-sm">terms of service</span>{" "}
            &{" "}
            <span className="text-blue-500 hover:underline md:text-lg sm:text-base text-sm">privacy policy</span>
          </label>
        </div>
